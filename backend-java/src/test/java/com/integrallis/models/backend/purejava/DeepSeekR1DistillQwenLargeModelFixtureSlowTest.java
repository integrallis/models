...
@Tag("slow")
class DeepSeekR1DistillQwenLargeModelFixtureSlowTest {

  private static final int INTEGRATION_CONTEXT_LENGTH = 128;

  private static final ModelFixtureRequirement DEEPSEEK_R1_DISTILL_QWEN_7B_Q4_K_M =
      ModelFixtureRequirement.of("hf://bartowski/DeepSeek-R1-Distill-Qwen-7B-GGUF")
          .version("[1.0.0,2.0.0)")
          .variant("q4_k_m")
          .backend("pure-java")
  ...
  private static ModelFixtureDescriptor descriptorWithInstalledArtifact() {
    ModelFixtureDescriptor descriptor =
        ModelFixtureRegistry.fromClasspath()
            .resolve(DEEPSEEK_R1_DISTILL_QWEN_7B_Q4_K_M)
            .orElseThrow();
