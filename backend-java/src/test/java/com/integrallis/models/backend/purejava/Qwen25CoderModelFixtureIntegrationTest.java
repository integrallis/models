...
@Tag("integration")
class Qwen25CoderModelFixtureIntegrationTest {
  ...
  @Test
  void loadsQwen25Coder05BQ40ThroughModelFixture() {
    assertLoadsQwen25Coder(QWEN25_CODER_0_5B_Q4_0);
  }

  @Test
  void loadsQwen25Coder05BQ80ThroughModelFixture() {
    assertLoadsQwen25Coder(QWEN25_CODER_0_5B_Q8_0);
  }

  @Test
  void loadsQwen25Coder15BQ40ThroughModelFixture() {
    assertLoadsQwen25Coder(QWEN25_CODER_1_5B_Q4_0);
  }

  @Test
  void loadsQwen25Coder15BQ80ThroughModelFixture() {
    assertLoadsQwen25Coder(QWEN25_CODER_1_5B_Q8_0);
  }

  @Test
  void loadsQwen25Coder3BQ40ThroughModelFixture() {
  ...
  private static void assertLoadsQwen25Coder(ModelFixtureRequirement requirement) {
