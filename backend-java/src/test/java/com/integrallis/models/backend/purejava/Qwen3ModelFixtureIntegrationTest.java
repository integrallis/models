...
@Tag("integration")
class Qwen3ModelFixtureIntegrationTest {
  ...
  @Test
  void loadsQwen306BQ40ThroughModelFixture() {
    assertLoadsQwen3(QWEN3_0_6B_Q4_0);
  }

  @Test
  void loadsQwen317BQ80ThroughModelFixture() {
  ...
  private static void assertLoadsQwen3(ModelFixtureRequirement requirement) {
    ModelFixtureDescriptor descriptor =
