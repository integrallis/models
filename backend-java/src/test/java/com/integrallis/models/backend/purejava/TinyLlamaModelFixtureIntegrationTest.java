...
@Tag("integration")
class TinyLlamaModelFixtureIntegrationTest {
  ...
  @Test
  void loadsTinyLlamaThroughModelFixture() {
    ModelFixtureDescriptor descriptor = descriptorWithInstalledModel();
  ...
  private static ModelFixtureDescriptor descriptorWithInstalledModel() {
