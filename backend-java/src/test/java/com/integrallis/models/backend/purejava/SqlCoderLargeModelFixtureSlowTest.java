...
@Tag("slow")
class SqlCoderLargeModelFixtureSlowTest {
  ...
  private static final ModelFixtureRequirement SQLCODER_7B_2_Q5_K_M =
      ModelFixtureRequirement.of("hf://defog/sqlcoder-7b-2")
          .version("[2.0.0,3.0.0)")
          .variant("q5_k_m")
          .backend("pure-java")
  ...
  private static ModelFixtureDescriptor descriptorWithInstalledArtifact() {
    ModelFixtureDescriptor descriptor =
        ModelFixtureRegistry.fromClasspath().resolve(SQLCODER_7B_2_Q5_K_M).orElseThrow();
