...
public record PureJavaPlanConfiguration(
  ...
  public static final String STAGED_Q4_QKV_PROPERTY = "models.purejava.stagedQ4Qkv";
  ...
  static PureJavaPlanConfiguration from(
    ...
    return new PureJavaPlanConfiguration(
        ...
        stagedQ4Qkv(configured(STAGED_Q4_QKV_PROPERTY, deployment, recommendations)));
  }
  ...
  static boolean stagedQ4Qkv(String configured) {
    return configured != null && booleanProperty(STAGED_Q4_QKV_PROPERTY, configured);
  }
