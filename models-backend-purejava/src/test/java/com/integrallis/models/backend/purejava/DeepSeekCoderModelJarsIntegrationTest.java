...
@Tag("integration")
class DeepSeekCoderModelJarsIntegrationTest {

  private static final int INTEGRATION_CONTEXT_LENGTH = 128;

  private static final ModelJarRequirement DEEPSEEK_CODER_1_3B_Q4_K_M =
      ModelJarRequirement.forSource("hf://TheBloke/deepseek-coder-1.3b-instruct-GGUF")
  ...
  private static ModelJarDescriptor descriptorWithInstalledArtifact() {
    ModelJarDescriptor descriptor =
        ModelJarRegistry.fromClasspath().resolve(DEEPSEEK_CODER_1_3B_Q4_K_M).orElseThrow();
