...
@Tag("slow")
class Qwen25CoderLargeModelJarsSlowTest {
  ...
  @Test
  void loadsQwen25Coder7BQ40ThroughModelJars() {
    ...
    try (PureJavaBackend backend = PureJavaBackend.load(descriptor)) {
      ...
      assertThat(backend.metadata().contextLength()).isGreaterThanOrEqualTo(131_072);
