...
@Tag("slow")
class FinR1LargeModelJarsSlowTest {
  ...
  private static final ModelJarRequirement FIN_R1_7B_Q4_K_M =
      ModelJarRequirement.forSource("hf://bartowski/SUFE-AIFLM-Lab_Fin-R1-GGUF")
  ...
  private static ModelJarDescriptor descriptorWithInstalledArtifact() {
    return ModelOracleTestSupport.installedDescriptor(
        FIN_R1_7B_Q4_K_M, ":models-backend-purejava:downloadFinR17BQ4KMModel");
  }
}
