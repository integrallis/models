...
dependencies {
    ...
    // Same GgufBatchedMatrixKernel SPI as the Rust kernel, so moving projections to a device does
    // not change the shape of the decision path.
    testImplementation(project(":backend-cuda"))
