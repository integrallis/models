...
```kotlin
dependencies {
    implementation("com.integrallis:models:0.2.0")
    implementation("com.integrallis:backend-java:0.2.0") // or backend-native
}
```
...
```kotlin
dependencies {
    implementation("com.integrallis:backend-apple:0.2.0")
}
```
