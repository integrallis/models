...
**Status:** runtime assumptions audited against Models 0.3.33. Rungs 1–2 were measured downstream
...
Models 0.3.33 has no adapter/LoRA loader or swap API, so adapter experiments remain blocked. It does
