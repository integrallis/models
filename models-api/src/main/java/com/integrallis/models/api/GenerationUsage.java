...
/** Exact token counts for one completed text generation. */
public record GenerationUsage(int promptTokens, int completionTokens) {
  ...
  /** Returns the prompt and completion token counts combined. */
