  ...
  static void multiply(
    ...
    for (@Parallel int outputIndex = 0; outputIndex < batchSize * rows; outputIndex++) {
      ...
      for (int block = 0; block < blocks; block++) {
        ...
        int integerSum =
            pairProduct(weights, weightOffset, activations, quantOffset, 0)
                + pairProduct(weights, weightOffset, activations, quantOffset, 1)
                + pairProduct(weights, weightOffset, activations, quantOffset, 2)
                + pairProduct(weights, weightOffset, activations, quantOffset, 3)
                + pairProduct(weights, weightOffset, activations, quantOffset, 4)
                + pairProduct(weights, weightOffset, activations, quantOffset, 5)
                + pairProduct(weights, weightOffset, activations, quantOffset, 6)
                + pairProduct(weights, weightOffset, activations, quantOffset, 7)
                + pairProduct(weights, weightOffset, activations, quantOffset, 8)
                + pairProduct(weights, weightOffset, activations, quantOffset, 9)
                + pairProduct(weights, weightOffset, activations, quantOffset, 10)
                + pairProduct(weights, weightOffset, activations, quantOffset, 11)
                + pairProduct(weights, weightOffset, activations, quantOffset, 12)
                + pairProduct(weights, weightOffset, activations, quantOffset, 13)
                + pairProduct(weights, weightOffset, activations, quantOffset, 14)
                + pairProduct(weights, weightOffset, activations, quantOffset, 15);
        float scale =
